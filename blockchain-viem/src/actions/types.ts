...
export type ReadFunctionName<TAbi extends Abi> = ContractFunctionName<
  TAbi,
  "pure" | "view"
>;
...
type ContractAction<
  ...
  TFuncName extends ContractFunctionName<TAbi, TStatus> = ContractFunctionName<
    TAbi,
    TStatus
  >,
> = {
...
> = ContractAction<"payable" | "nonpayable", TAbi, TFuncName> & {
  value?: bigint;
};
